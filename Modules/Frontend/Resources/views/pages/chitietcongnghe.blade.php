...
@section('content')
    ...
    <div class="banner-fix">
        <div class="slider-main owl-carousel owl-theme">
            <div class="item bg-img" style="background-image: url('{{ asset('/'). $congnghe['image']['url'] }}')">
            </div>
        </div>
    </div>
            ...
            <div class="row row-7">
                ...
                <div class="col-md-12 pdd-7">
                    <ul class="breadcrumb">
                        ...
                        <li><a href="{{ route('frontend.loaicongnghe', ['id'=>$congnghe['loaicongnghe']['id'], 'slug'=>$congnghe['loaicongnghe']['slug']]) }}">{{ $congnghe['loaicongnghe']['title'] }}</a></li>
                        <li class="active"><a href="">{{ $congnghe['title'] }}</a></li>
                    </ul>
                </div>
                                    ...
                                    <div class="tab-content">
                                        <div id="home-dt" class="tab-pane fade in active">
                                            ...
                                            <div class="date-time" style="margin-bottom: 20px">
                                                {{ date_format(date_create($congnghe['updated_at']),"d-m-Y") }}
                                            </div>
                                        </div>
                                    </div>
                                </div>
