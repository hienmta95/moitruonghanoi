    ...
    <div class="sp-push-form">
        ...
        @csrf
            ...
            <div class="form-group @if (count($errors->all())) {{$errors->has(['description_en']) ? 'has-error' : 'has-success'}} @endif">
                ...
                <textarea id="description_en_loaiduan" class="form-control{{ $errors->has('description_en') ? ' has-error' : '' }}" name="description_en" maxlength="255" rows="3">{{ old('description_en') }}</textarea>
