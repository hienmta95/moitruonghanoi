...
{{--        <a class="btn btn-success" href="{{ route('backend.lienhe.create') }}">Tạo mới</a>--}}
    ...
    <table id="w0" class="table table-striped table-bordered detail-view">
        <tbody>
            ...
            <tr><th>Di động </th><td>{!! $lienhe->didong ? $lienhe->didong : "<span class='not-set'>(not set)</span>"  !!}</td></tr>
            ...
            <tr><th>Điạ chỉ</th><td>{!! $lienhe->diachi ? $lienhe->diachi : "<span class='not-set'>(not set)</span>"  !!}</td></tr>
            <tr><th>Công ty </th><td>{!! $lienhe->congty ? $lienhe->congty : "<span class='not-set'>(not set)</span>"  !!}</td></tr>
            <tr><th>Chủ đề</th><td>{!! $lienhe->chude ? $lienhe->chude : "<span class='not-set'>(not set)</span>"  !!}</td></tr>
