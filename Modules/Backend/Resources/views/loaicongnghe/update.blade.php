    ...
    <div class="sp-push-form">
        <form action="{{ route('backend.loaicongnghe.update', $loaicongnghe->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group @if (count($errors->all())) {{$errors->has(['title_en']) ? 'has-error' : 'has-success'}} @endif" >
                ...
                <input type="text" class="form-control{{ $errors->has('title_en') ? ' has-error' : '' }}" name="title_en" value="{{ $loaicongnghe->title_en }}">
            ...
            <div class="form-group @if (count($errors->all())) {{$errors->has(['description_en']) ? 'has-error' : 'has-success'}} @endif">
                ...
                <textarea id="description_en_loaicongnghe" class="form-control{{ $errors->has('description_en') ? ' has-error' : '' }}" name="description_en" maxlength="255" rows="3">{{ $loaicongnghe->description_en }}</textarea>
