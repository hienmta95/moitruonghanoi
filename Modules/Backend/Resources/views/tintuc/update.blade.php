    ...
    <div class="sp-push-form">
        <form action="{{ route('backend.tintuc.update', $tintuc->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group @if (count($errors->all())) {{$errors->has(['title_en']) ? 'has-error' : 'has-success'}} @endif" >
                ...
                <input type="text" class="form-control{{ $errors->has('title_en') ? ' has-error' : '' }}" name="title_en" value="{{ $tintuc->title_en }}">
            ...
            <div class="form-group @if (count($errors->all())) {{$errors->has(['noidung_en)']) ? 'has-error' : 'has-success'}} @endif">
                ...
                <textarea id="noidung_en_tintuc" class="form-control{{ $errors->has('noidung_en') ? ' has-error' : '' }}" name="noidung_en" maxlength="255" rows="3">{{ $tintuc->noidung_en }}</textarea>
                <script type="text/javascript">
                    var editor = CKEDITOR.replace('noidung_en_tintuc',{
                        language:'vi',
                        filebrowserBrowseUrl :'/js/ckfinder/ckfinder.html',
                        filebrowserImageBrowseUrl : '/js/ckfinder/ckfinder.html?type=Images',
                        filebrowserFlashBrowseUrl : '/js/ckfinder/ckfinder.html?type=Flash',
            ...
            <div class="form-group @if (count($errors->all())) {{$errors->has(['description']) ? 'has-error' : 'has-success'}} @endif">
                ...
                <textarea id="description_tintuc" class="form-control{{ $errors->has('description') ? ' has-error' : '' }}" name="description" maxlength="255" rows="1">{{ $tintuc->description }}</textarea>
                <script type="text/javascript">
                    var editor = CKEDITOR.replace('description_tintuc',{
                        language:'vi',
                        filebrowserBrowseUrl :'/js/ckfinder/ckfinder.html',
                        filebrowserImageBrowseUrl : '/js/ckfinder/ckfinder.html?type=Images',
                        filebrowserFlashBrowseUrl : '/js/ckfinder/ckfinder.html?type=Flash',
            ...
            <div class="form-group @if (count($errors->all())) {{$errors->has(['description_en']) ? 'has-error' : 'has-success'}} @endif">
                ...
                <textarea id="description_en_tintuc" class="form-control{{ $errors->has('description_en') ? ' has-error' : '' }}" name="description_en" maxlength="255" rows="1">{{ $tintuc->description_en }}</textarea>
                <script type="text/javascript">
                    var editor = CKEDITOR.replace('description_en_tintuc',{
                        language:'vi',
                        filebrowserBrowseUrl :'/js/ckfinder/ckfinder.html',
                        filebrowserImageBrowseUrl : '/js/ckfinder/ckfinder.html?type=Images',
                        filebrowserFlashBrowseUrl : '/js/ckfinder/ckfinder.html?type=Flash',
