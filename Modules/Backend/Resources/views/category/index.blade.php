...
<div class="sp-push-index">
    ...
    <p>
        <a class="btn btn-success" href="{{ route('backend.category.create') }}">Tạo mới loại sản phẩm</a>
    </p>
    <div class="grid-view" id="w0">
        <div class="summary">
            <table class="table table-striped table-bordered table-style" id="category-table">
                <thead>
                    <tr>
                        ...
                        <th class="orderable-col">Số sản phẩm</th>
...
<script>
    var table = $('#category-table').DataTable({
        ...
        ajax: '{!! route('backend.category.indexData') !!}',
        ...
        "initComplete": function () {
            $('#category-table_paginate').css({"float": "left"});
            var r = $('#category-table tfoot tr');
            $('#category-table thead').append(r);
            this.api().columns().every(function (i) {
                if (i != 0 && i != 9 && i != 1) {
                    ...
                    $('#category-table thead tr th input').css({"width": "100%", "margin": "0px 0px 0px 0px"});
                }
            });
