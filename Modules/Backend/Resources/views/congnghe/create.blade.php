...
<ul class="breadcrumb">
    ...
    <li class="active">Tạo mới công nghệ</li>
</ul>
@endsection
@section('content')
    {{--<h1>Create congnghe</h1>--}}
    <div class="sp-push-form">
        <form id="congnghe_create" action="{{ route('backend.congnghe.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
